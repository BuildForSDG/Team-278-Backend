...
def populateInvestor(N):
    ...
    for entry in range(N):
        ...
        # Create new Post Entry
        investor = Investor.objects.get_or_create(  name = fake_name,
                                            lastname = fake_lastname,
                                            full_description = fake_description,
                                            location = fake_location,
                                            city = fake_city,
...
if __name__ == '__main__':
    ...
    print("The Investor contains {} data".format(len(Investor.objects.all())))
    value = input("Would you like to add more data? (y/n) ")
    if value == "y":
        populateInvestor(int(input("How many Investors you want to create? ")))
        print('Populating Investor Complete')
        print('')
        print('*************************************')
